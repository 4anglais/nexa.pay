  ...
  return (
    <div className="flex min-h-screen flex-col bg-background selection:bg-primary selection:text-primary-foreground">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
                Generate professional payslips, and manage employees with the
                most modern platform built for Zambia.
              </p>
        ...
        <section
          id="features"
          className="border-t border-border/40 py-24 bg-muted/30"
        >
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mb-16 text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Powerful features to automate your monthly administrative tasks.
              </p>
            </div>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div
                  key={i}
                  className="group rounded-2xl border border-border/50 bg-background p-8 transition-all hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5"
                >
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="rounded-3xl bg-primary px-6 py-16 text-center text-primary-foreground sm:px-12">
              ...
              <p className="mx-auto mt-4 max-w-xl opacity-90">
                Join NexaPayslips to manage your payroll efficiently every
                month.
              </p>
              <div className="mt-10 flex justify-center">
                <Button
                  ...
                  size="lg"
                  variant="secondary"
                  className="h-12 px-8 font-bold text-primary"
                >
          ...
          <div className="flex flex-col md:flex-row justify-between gap-12">
            ...
            <div className="max-w-xs">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                The payroll management platform for modern businesses.
                Simplifying administrative tasks so you can focus on growth.
              </p>
              <p className="mt-4 text-sm text-muted-foreground">
                Email: angelphiri@gmail.com
                <br />
